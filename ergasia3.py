A = '''The Project Gutenberg EBook of A Tale of Two Cities, by Charles Dickens
...
disallowed_characters = "0123456789!#$%&'()*+,-./:;<=>?@[\]^_`{|}~"
...
def LengthStats(y):
    ...
    for k,v in wordcount.items():
         #for key in sorted(wordcount):  (ηθελα να  τυπωσει τα στατιστικα ταξινομημενα σε σχεση με τα κλειδια αλλα δεν δούλεψε...)
          print (k,"letter/s :",v,"word/s")                             
    return None
d=LengthStats(tmp)
